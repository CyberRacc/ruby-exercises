...
def ascii_translator(number)
  return number.chr # Converts the given number to its corresponding ASCII character
end
...
def common_sports(current_sports, favorite_sports)
  # The intersection method returns a new array containing elements that are common to both arrays.
...
# uniq: Removes duplicate elements from the array, returning a new array with unique elements.
